...
class ClassManagementView(tk.Frame):
    ...
    def create_widgets(self):
        ...
        tk.Label(class_frame, text="Class Name (e.g., Grade 1):").pack(side="left")
        ...
        tk.Label(section_frame, text="Select Class:").grid(row=0, column=0, sticky=tk.W)
        ...
        tk.Label(section_frame, text="Section Name (e.g., A):").grid(row=1, column=0, sticky=tk.W)

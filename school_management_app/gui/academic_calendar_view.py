...
class AcademicCalendarView(tk.Frame):
    ...
    def create_widgets(self):
        ...
        tk.Label(year_frame, text="Year (e.g., 2024/2025):").pack(side="left")
        ...
        tk.Label(term_frame, text="Select Year:").grid(row=0, column=0, sticky=tk.W)
        ...
        tk.Label(term_frame, text="Term Name:").grid(row=1, column=0, sticky=tk.W)
        self.term_name_entry = tk.Entry(term_frame)
        self.term_name_entry.grid(row=1, column=1, pady=2)

        tk.Label(term_frame, text="Start Date (YYYY-MM-DD):").grid(row=2, column=0, sticky=tk.W)
        self.start_date_entry = tk.Entry(term_frame)
        self.start_date_entry.grid(row=2, column=1, pady=2)

        tk.Label(term_frame, text="End Date (YYYY-MM-DD):").grid(row=3, column=0, sticky=tk.W)
